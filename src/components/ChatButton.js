...
const ChatButton = ({ isOpen }) => {
  const handleWhatsAppRedirect = (e) => {
    e.stopPropagation();
    const message = "Olá! Gostaria de saber mais sobre os serviços da BlackBox iGaming.";
  ...
  return (
    <div className="chat-button-container" onClick={handleWhatsAppRedirect} style={{ cursor: 'pointer' }}>
      <AnimatePresence>
        {!isOpen && (
          <motion.div 
            className="chat-hint"
          ...
          >
            <div className="hint-content" style={{ cursor: 'pointer' }}>
