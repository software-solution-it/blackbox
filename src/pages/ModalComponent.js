...
const ModalComponent = ({ closeModal }) => {
  ...
  const handleWhatsAppInput = (e) => {
    ...
    setWhatsappError(isValid || !formatted ? '' : 'Número inválido');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userName.trim()) {
      ...
      if (!cleanNumber) {
        setWhatsappError("Telefone é obrigatório");
        valid = false;
      } else if (!validateWhatsApp(whatsappNumber)) {
  ...
  const canSubmit = isValidNumber && userName.trim() && !isSubmitting;
        ...
        >
          ...
          <div className="chat-content">
            <p className="intro-message">
              Para te atender da melhor forma, preencha o <strong>nome</strong> e o seu <strong>whatsapp</strong>
            </p>
            
            <form onSubmit={handleSubmit} className="contact-form">
              <div className="input-group">
                <label htmlFor="userName" className="input-label">Qual o seu nome?</label>
                <input
                  id="userName"
                  type="text"
                  value={userName}
              ...
              <div className="input-group">
                <label htmlFor="whatsappNumber" className="input-label">Qual o seu whatsapp?</label>
                <input
                  id="whatsappNumber"
                  type="tel"
              ...
              <p className="form-instruction" style={{ 
                textAlign: 'left', 
                marginBottom: '0px',
                fontSize: '0.8em',
                fontWeight: '500',
                ...
                Para iniciar atendimento preencha o formulário acima
              </p>

              <button 
                type="submit" 
                className={`whatsapp-submit-button ${!canSubmit ? 'disabled' : ''}`}
              >
